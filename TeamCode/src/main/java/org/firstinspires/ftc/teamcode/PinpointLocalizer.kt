...
class PinpointLocalizer(
    ...
    @JvmField val driver: GoBildaPinpointDriver

    @JvmField val initialParDirection: GoBildaPinpointDriver.EncoderDirection

    @JvmField val initialPerpDirection: GoBildaPinpointDriver.EncoderDirection
