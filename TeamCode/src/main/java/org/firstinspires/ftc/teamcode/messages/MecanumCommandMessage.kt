...
class MecanumCommandMessage(
    ...
    @JvmField
    var leftFrontPower: Double = leftFrontPower
    @JvmField
    var leftBackPower: Double = leftBackPower
    @JvmField
    var rightBackPower: Double = rightBackPower
    @JvmField
    var rightFrontPower: Double = rightFrontPower
}
