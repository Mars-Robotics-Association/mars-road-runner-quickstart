 ...
 *
 * <p>All {@link FlywheelSimple.Params} (kS, kV, kA, kP, velLpfCutoffHz, readyThreshold, etc.) are
 ...
 *
 * <ul>
 *   <li>Right bumper — spin at {@link #TARGET_TPS}
 ...
 *
 * <ol>
 *   <li>Run {@code FlywheelsFeedforwardTuning} first to measure kS, kV, and kA, then paste those
 *       values into {@link FlywheelSimple#PARAMS}.
 *   <li>Set {@link #TARGET_TPS} to a target speed in the Dashboard.
 ...
 *   <li>Check {@code isReady}: it should go true within a second or two of spin-up at a good kP.
 * </ol>
 */
@Config
@TeleOp(name = "FlywheelSimple Tuning Harness", group = "Tuning")
public class FlywheelSimpleTuningHarness extends MarsLinearOpMode {
    ...
    public void runOpMode() {
        ...
        LinkedMotorGroup group =
                new LinkedMotorGroup(
                        hardwareMap,
