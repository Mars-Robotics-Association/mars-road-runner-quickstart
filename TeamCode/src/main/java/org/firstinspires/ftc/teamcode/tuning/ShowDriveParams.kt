...
class ShowDriveParams : MarsLinearOpMode() {
    ...
    private fun dumpMecanum() {
        val p = MecanumDrive.PARAMS
    ...
    private fun dumpTank() {
        val p = TankDrive.PARAMS
