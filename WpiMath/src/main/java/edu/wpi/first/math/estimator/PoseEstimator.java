 ...
 * drivetrain (e.g., DifferentialDrivePoseEstimator). It is intended to be a drop-in
...
public class PoseEstimator<T> {
    ...
    public void resetTranslation(Translation2d translation) {
        ...
        final Map.Entry<Double, VisionUpdate> latestVisionUpdate = m_visionUpdates.lastEntry();
        m_odometryPoseBuffer.clear();
        m_visionUpdates.clear();
