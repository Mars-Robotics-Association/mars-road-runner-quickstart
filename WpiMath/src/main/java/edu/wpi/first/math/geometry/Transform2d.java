...
// import edu.wpi.edu.wpi.first.math.geometry.proto.Transform2dProto;
// import edu.wpi.edu.wpi.first.math.geometry.struct.Transform2dStruct;
...
//    }
    ...
    /**
     * Constructs a transform from an SE(2) homogeneous transformation matrix.
     *
     * @param matrix The 3x3 SE(2) transformation matrix.
     */
    ...
    /**
     * Returns the SE(2) homogeneous transformation matrix representation of this transform.
     *
     * @return The 3x3 SE(2) transformation matrix.
     */
    public Matrix<N3, N3> toMatrix() {
        var cos = m_rotation.getCos();
        var sin = m_rotation.getSin();
        return MatBuilder.fill(Nat.N3(), Nat.N3(),
                cos, -sin, m_translation.getX(),
                sin,  cos, m_translation.getY(),
                0,    0,   1);
    }
